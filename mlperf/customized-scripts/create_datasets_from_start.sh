...
#SQuAD Large Checkpoint
	...
	cd /workspace/bert/data/download/nvidia_pretrained && \
		lftp -c "pget -n 20 https://api.ngc.nvidia.com/v2/models/nvidia/bert_tf_ckpt_large_qa_squad11_amp_384/versions/19.03.1/zip -o bert_tf_ckpt_large_qa_squad11_amp_384_19.03.1.zip" \
...
cd /workspace/bert/data/download/nvidia_pretrained && \
	lftp -c "pget -n 20 https://api.ngc.nvidia.com/v2/models/nvidia/bert_tf_ckpt_base_qa_squad11_amp_128/versions/19.03.1/zip -o bert_tf_ckpt_base_qa_squad11_amp_128_19.03.1.zip" \
...
cd /workspace/bert/data/download/nvidia_pretrained && \
	lftp -c "pget -n 20 https://api.ngc.nvidia.com/v2/models/nvidia/bert_tf_ckpt_large_pretraining_amp_lamb/versions/19.03.1/zip -o bert_tf_ckpt_large_pretraining_amp_lamb_19.03.1.zip" \
